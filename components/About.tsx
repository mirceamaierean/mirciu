    ...
    <section id="about" className="max-w-sm sm:max-w-7xl mx-auto pt-28">
      <div className="flex flex-col items-center pb-12">
        ...
        <h2 className="text-xl font-lg mx-auto text-center">
          This deck of cards is a summary of who I am, what I do and what I like.<span className="hidden sm:block">Drag the cards arround the board to discover more about me</span>
        </h2>
      </div>
